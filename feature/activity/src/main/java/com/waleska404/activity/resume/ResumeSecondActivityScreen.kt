...
@Composable
fun ResumeSecondActivityScreen(
    ...
    Column(
        ...
        HeaderResumeSecondScreen()
        CallbacksResumeSecondScreen(initialState = initialState)
        FooterResumeSecondScreen(
...
@Composable
fun CallbacksResumeSecondScreen(
    initialState: Boolean
) {
    Card(
        modifier = Modifier
